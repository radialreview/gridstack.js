...
class GridStack {
    ...
    constructor(el, opts = {}) {
        ...
        let bk = (_a = opts.columnOpts) === null || _a === void 0 ? void 0 : _a.breakpoints;
        ...
        const grandParent = (_c = this.el.parentElement) === null || _c === void 0 ? void 0 : _c.parentElement;
        let parentGridItem = (grandParent === null || grandParent === void 0 ? void 0 : grandParent.classList.contains(gridDefaults.itemClass)) ? grandParent.gridstackNode : undefined;
        if (parentGridItem) {
        ...
        items.forEach(w => {
            ...
            if (item) {
                ...
                if (Utils.samePos(item, w)) {
                    this.moveNode(item, Object.assign(Object.assign({}, w), { forceCollide: true }));
                }
    ...
    checkDynamicColumn() {
        ...
        if (newColumn !== column) {
            const bk = (_b = resp.breakpoints) === null || _b === void 0 ? void 0 : _b.find(b => b.c === newColumn);
    ...
    _setupAcceptWidget() {
        ...
        dd.droppable(this.el, {
            ...
            el.gridstackNode = node;
            node.el = el;
            let subGrid = (_c = (_b = node.subGrid) === null || _b === void 0 ? void 0 : _b.el) === null || _c === void 0 ? void 0 : _c.gridstack; // set when actual sub-grid present
            // @ts-ignore
    ...
    _dragOrResize(el, event, ui, node, cellWidth, cellHeight) {
        ...
        if (event.type === 'drag') {
            ...
            let left = ui.position.left + (ui.position.left > ((_b = (_a = node._lastUiPosition) === null || _a === void 0 ? void 0 : _a.left) !== null && _b !== void 0 ? _b : 0) ? -mRight : mLeft);
            let top = ui.position.top + (ui.position.top > ((_d = (_c = node._lastUiPosition) === null || _c === void 0 ? void 0 : _c.top) !== null && _d !== void 0 ? _d : 0) ? -mBottom : mTop);
